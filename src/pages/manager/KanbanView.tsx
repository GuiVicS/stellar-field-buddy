  ...
  return (
    <div className="p-4 lg:p-6 space-y-4 animate-fade-in">
      ...
      <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-hide">
        {columns.map(col => {
          const orders = mockServiceOrders.filter(o => o.status === col.status);
          return (
...
const KanbanCard: React.FC<{ os: ServiceOrder }> = ({ os }) => {
  ...
  return (
    <Card className="p-3 shadow-card border-border/50 hover:shadow-elevated transition-all cursor-pointer">
